...
/***/ function(module, exports, __webpack_require__) {
	...
	var event = new Event('gamestatuschange');
	...
	var Game = React.createClass({
	  ...
	  updateGame: function updateGame(tile, isFlagging) {
	    if (isFlagging) {
	      tile.toggleFlag();
	    } else {
	      tile.explore();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      null,
	      React.createElement(Modal, { revealed: this.modalRevealed, modalContent: this.modalContent, newGame: this.newGame }),
	      ...
	      return this.props.board.grid.map(function (row, i) {
	        return React.createElement(
	          ...
	          row.map(function (tile, j) {
	            return React.createElement(Tile, { tile: tile, key: i + ', ' + j, update: _this.props.update });
	          })
	        );
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: className, onMouseDown: this.handleClick },
	      this.displayValue()
	    );
	  }
	});
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "button",
	          { className: "modal-button", onClick: this.restart },
	          "Play Again?"
	        )
	      ),
	      React.createElement("div", { className: "modal-screen js-hide-modal" })
	    );
	  }
	});
